...
namespace Machines
{
    ...
    public class MiniTrashMachine : MonoBehaviour, ISaveable
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            _gameManager.CompleteTask(new MachineLabActivity(EMachineActivity.OnEnter, EMachine.MiniTrashMachine));
        }
